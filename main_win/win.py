...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        mainWindow.resize(724, 548)
        mainWindow.setMouseTracking(True)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/newPrefix/icon/gamenergy.PNG"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(":/newPrefix/icon/gamenergy.PNG"), QtGui.QIcon.Selected, QtGui.QIcon.On)
...
"border-radius:0px;}")
        ...
        self.label_7.setStyleSheet("border-image: url(:/newPrefix/icon/gamenergy.PNG);")
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "GamEnergy"))
        self.label_4.setText(_translate("mainWindow", "تشخیص PPE"))
        self.label_5.setText(_translate("mainWindow", "تنظیمات"))
        self.label_3.setText(_translate("mainWindow", " انتخاب مدل"))
        ...
        self.label_10.setText(_translate("mainWindow", "ورودی"))
        ...
        self.label_2.setText(_translate("mainWindow", "مقدار آستانه 1 (IOU)"))
        self.label.setText(_translate("mainWindow", "مقدار آستانه 2 (CONF)"))
        self.label_8.setText(_translate("mainWindow", "تاخیر"))
        self.checkBox.setText(_translate("mainWindow", "فعالسازی"))
        self.saveCheckBox.setText(_translate("mainWindow", "ذخیره نتایج"))
        self.label_11.setText(_translate("mainWindow", "نمایش نتایج"))
        self.label_6.setText(_translate("mainWindow", "نمایش"))
